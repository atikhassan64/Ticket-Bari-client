                    ...
                    <div className="max-w-md mx-auto lg:max-w-none">
                        ...
                        >
                            ...
                            <p className="text-gray-500 dark:text-gray-400 mb-6 sm:mb-8 text-sm sm:text-base">
                                Join TicketBari and start booking tickets instantly.
                            </p>
                        </motion.div>

                        <form onSubmit={handleSubmit(handleRegister)} className="space-y-4 sm:space-y-5">
                            {/* Google Sign Up */}
                            <motion.button
                                type='button'
                            ...
                            >
                                ...
                                <div className="relative">
                                    <FaUser className="absolute left-3 sm:left-4 top-1/2 transform -translate-y-1/2 text-gray-400 w-4 h-4 sm:w-5 sm:h-5" />
                                    <input
                                        type="text"
                            ...
                            >
                                ...
                                <div className="relative">
                                    <FaImage className="absolute left-3 sm:left-4 top-1/2 transform -translate-y-1/2 text-gray-400 w-4 h-4 sm:w-5 sm:h-5" />
                                    <input
                                        type="url"
                                ...
                                {errors.photoURL?.type === "required" && (
                                    <p className='text-xs sm:text-sm text-red-500 mt-1 flex items-center gap-1'>
                                        <span>⚠</span> Photo URL is required
                                    </p>
                                )}
                            </motion.div>
                            ...
                            >
                                <label className="flex items-start gap-3 text-sm sm:text-base cursor-pointer">
                                    <input
                                        ...
                                        className="w-4 h-4 sm:w-5 sm:h-5 text-secondary-content bg-gray-100 border-gray-300 rounded focus:ring-secondary-content focus:ring-2 mt-0.5"
                                    />
                                    <span className="text-gray-600 dark:text-gray-400 leading-relaxed">
                                        I agree to the{" "}
                                        <span className="text-secondary-content font-semibold hover:underline">Terms of Service</span>,{" "}
                                        <span className="text-secondary-content font-semibold hover:underline">Privacy Policy</span>{" "}
                                        and <span className="text-secondary-content font-semibold hover:underline">Fee Structure</span>.
                                    </span>
                                </label>
                                {errors.box?.type === "required" && (
                                    <p className='text-xs sm:text-sm text-red-500 mt-1 flex items-center gap-1'>
                                        <span>⚠</span> You must agree to the terms and conditions
                                    </p>
                                )}
                            </motion.div>
