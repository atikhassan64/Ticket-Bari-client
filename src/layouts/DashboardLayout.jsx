...
//                         {/* Vendor Profile */}
//                         <li>
//                             <NavLink to={`/dashboard/vendor-profile`} className="is-drawer-close:tooltip is-drawer-close:tooltip-right" data-tip="Vendor Profile">
//                                 {/* Profile icon */}
...
import { MdAssignmentTurnedIn, MdOutlineAnalytics, MdBookmarkAdded, MdHistory } from "react-icons/md";
import { VscDiffAdded } from "react-icons/vsc";
import logo from "../assets/logo.png";
import logoWhite from "../assets/logo-white.png";
...
const DashboardLayout = () => {
    ...
    // 🔹 এখানে তুমি auth বা context থেকে role নিতে পারো
    const role = "user"; // admin | vendor | user
        ...
        <div className="drawer lg:drawer-open">
            ...
            <div className="drawer-content">
                ...
                <nav className="navbar w-full bg-base-300">
                    ...
                    <div className='px-1'>
                        <div className='w-30'>
                            <NavLink to="/">{theme === "dark" ? <img src={logoWhite} alt="" /> : <img src={logo} alt="" />}</NavLink>
                        </div>
                    </div>
                </nav>
