                ...
                >
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                        <input
                            ...
                            defaultValue={ticket.price}
                            {...register("price", { required: true })}
                            className="w-full mt-2 border border-gray-300 rounded-lg focus:outline-primary-content px-4 py-2 bg-base-100"
                            placeholder="Price"
                        />
                        <input
                            type="number"
                            defaultValue={ticket.quantity}
                            {...register("quantity", { required: true })}
                            className="w-full mt-2 border border-gray-300 focus:outline-primary-content rounded-lg px-4 py-2 bg-base-100"
                            placeholder="Quantity"
                        />
                    </div>
                    ...
                    <input
                        type="file"
                        {...register("image")}
                        className="w-full mt-2 border focus:outline-primary-content border-gray-300 rounded-lg px-4 py-2 bg-base-100 file-input file-input-bordered"
                    />
